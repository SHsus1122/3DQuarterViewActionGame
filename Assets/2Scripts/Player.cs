...
public class Player : MonoBehaviour
{
    ...
    void Turn()
    {
        ...
        if (fDown && !isDead)
        {
            ...
            {
                Vector3 netxVec = rayHit.point - transform.position;
                netxVec.y = 0;
                transform.LookAt(transform.position + netxVec);
            }
        }
    }
    ...
    void Jump()
    {
        if (jDwon && moveVec == Vector3.zero && !isJump && !isDodge && !isSwap && !isDead)
        {
    ...
    void Grenade()
    {
        ...
        if (gDown && !isReload && !isSwap && !isDead)
        {
            ...
            if (Physics.Raycast(ray, out rayHit, 100))
            {
                ...
                rigidGrenade.AddForce(netxVec, ForceMode.Impulse);
